...
show_ads: true
description: A person may genuinely see or hear something strange while the paranormal explanation remains unproven.
hero_summary: A person may genuinely see or hear something strange while the paranormal explanation remains unproven.
layout: default
...
title: Did something happen, or was it paranormal?
title_full: Did something happen, or was it paranormal?
display_title_short: Experience
display_title: Experience
heading_title: Did something happen, or was it paranormal?
page_heading_title: Did something happen, or was it paranormal?
source_count: 15
infographic_count: 3
planned_sections:
- Reported experience versus proposed cause
- Ordinary explanations that preserve the event
- How residual uncertainty should be worded
...
header:
  og_image: /assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_experience_vs_interp_18f1c3-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_experience_vs_interp_18f1c3-Illustration-1.webp
image: /assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_experience_vs_interp_18f1c3-Illustration-1-social.jpg
---
...
Within [Forteana]({{ 'forteana/' | relative_url }}), this distinction is especially important because haunting reports and UFO sightings often begin with sincere eyewitness testimony but end with competing explanations. Treating those two stages separately preserves respect for witnesses while keeping conclusions proportionate to the available evidence.

## Reported experience versus proposed cause

A witness normally reports a chain of events rather than a finished explanation. Consider two common examples:


<div class="content-enhancement content-enhancement--comparison" markdown="1">

* "I saw a bright object moving silently across the sky."
* "I heard footsteps upstairs and saw a dark figure in the hallway."
...
## Why witnesses can be accurate about the experience but mistaken about the cause

Separating experience from interpretation does not imply that witnesses are unreliable. Human perception is generally effective, but it evolved to construct meaningful interpretations from incomplete information rather than to function as a perfect recording device.

In both haunting and [UFO reports]({{ 'ufo-reports/' | relative_url }}), witnesses usually describe events that occur under conditions known to complicate perception:


<div class="content-enhancement content-enhancement--phrase-pills" markdown="1">

* darkness or twilight
* unexpected or emotionally charged situations
* long viewing distances
* unfamiliar sounds
* brief observation times
* fragmented memories reconstructed afterwards
...
A common misunderstanding is that proposing an ordinary explanation means claiming that "nothing happened". In careful anomalistic work, the opposite is usually true.

Something did happen: the task is to identify what.

### Hauntings

Many reported hauntings contain experiences that are psychologically or environmentally well documented:

* hypnagogic or hypnopompic experiences during transitions between sleeping and waking
* [sleep paralysis]({{ 'sleep-paralysis/' | relative_url }}) accompanied by a sensed presence

<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* ambiguous sounds interpreted within an emotionally charged setting
* expectation effects created by being told that a location is haunted
* environmental conditions such as lighting, acoustics or other physical features that encourage unusual perceptions
...
<img src="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_experience_vs_interp_18f1c3-Illustration-2-dark.svg" | relative_url }}" alt="Experience illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_experience_vs_interp_18f1c3-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_experience_vs_interp_18f1c3-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### UFO reports

The same principle applies to UFO cases.

Many famous sightings initially involved genuinely unusual observations:
...
In these cases the witness may accurately describe what they saw while misidentifying its nature. The existence of many solved UFO reports does not imply that every report is solved. It simply demonstrates why separating observation from explanation is methodologically valuable.

Modern discussions often use the term "unidentified" precisely because it avoids assuming either conventional or extraordinary causes before sufficient evidence exists.
...
Experiences do not occur in a cultural vacuum.

People interpret ambiguous events using concepts already available within their society. Across history, similar experiences have sometimes been explained as:

* spirits
* fairies
* religious [apparitions]({{ 'apparitions/' | relative_url }})
* witches
* extraterrestrials
...
Careful Fortean writing benefits from distinguishing different levels of confidence.

Instead of writing:

> "The witness encountered a ghost."

A more accurate description is:

> "The witness reported seeing a figure that they interpreted as a ghost."

Likewise, rather than stating:

> "An alien craft landed."

It is more precise to write:

> "Witnesses reported observing an unidentified object, later interpreted by some as extraterrestrial."

This style preserves three important distinctions:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* **The observation**: what was perceived.
* **The interpretation**: what the witness or later commentators believed caused it.
* **The current evidence**: whether independent investigation supports, contradicts or leaves that interpretation unresolved.

</div>

Residual uncertainty is not a weakness. It is often the most accurate summary available. Cases can reasonably be described as unresolved without implying that a paranormal explanation has therefore been demonstrated.
...
[Charles Fort]({{ 'charles-fort/' | relative_url }}) argued that unusual reports deserved attention because they challenged easy categorisation. Modern anomalistics adds an important refinement: attention should be directed not only at extraordinary claims but also at the structure of the experience itself.

Separating experience from interpretation allows investigators to respect witnesses without treating testimony as proof of a specific cause. It also prevents scepticism from collapsing into dismissal. An unexplained experience remains worthy of documentation even when its preferred paranormal explanation is unsupported.
...
<p class="fr-book-desc">Shows how vivid experiences need not imply paranormal causes.</p>
<div class="fr-book-actions">
