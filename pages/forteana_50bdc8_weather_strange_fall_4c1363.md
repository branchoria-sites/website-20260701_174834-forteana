...
- forteana_50bdc8_weather_strange_fall_4c1363_index
- forteana_50bdc8_weather_strange_fall_4c1363_saharan_dust_rain_c9a549
...
show_ads: true
description: Storms, waterspouts, whirlwinds, and heavy rain can make rare events look supernatural.
hero_summary: Storms, waterspouts, whirlwinds, and heavy rain can make rare events look supernatural.
layout: default
permalink: /weather/
sidebar_expanded_urls:
- /forteana/
nav_short_title: Weather
title: When Weather Makes the World Look Fortean
title_full: When Weather Makes the World Look Fortean
display_title_short: Weather
display_title: Weather
heading_title: When Weather Makes the World Look Fortean
page_heading_title: When Weather Makes the World Look Fortean
source_count: 91
infographic_count: 3
planned_sections:
- Waterspouts and whirlwinds
- Rainfall illusions and animals
- Why rare weather becomes folklore
...
- basename: forteana_50bdc8_weather_strange_fall_4c1363_saharan_dust_rain_c9a549
  title: Dust Rain | Weather
  permalink: /dust-rain/
  short_title: Dust Rain
...
next_link:
  ...
  heading_title: How Much Can Strange Witnesses Tell US?
header:
  og_image: /assets/images/forteana_50bdc8_weather_strange_fall_4c1363-overview-social.jpg
  preview_image: /assets/images/forteana_50bdc8_weather_strange_fall_4c1363-overview.webp
image: /assets/images/forteana_50bdc8_weather_strange_fall_4c1363-overview-social.jpg
---

## Introduction

Strange falls sit near the centre of [Forteana]({{ 'forteana/' | relative_url }}) because they feel like a direct violation of ordinary weather: fish on a road after a storm, frogs scattered across a field, red rain staining walls, spiders seeming to drift down from the sky. The most useful explanation is not that the sky is secretly full of animals or impossible matter, but that storms, [waterspouts]({{ 'waterspouts/' | relative_url }}), whirlwinds, floodwater, dust plumes and animal behaviour can briefly join up in ways that look supernatural. The same event can be real, misdescribed, locally meaningful and meteorologically plausible at the same time.
...
* **A severe storm was present.** Animal-fall reports are more credible when they coincide with thunderstorms, squalls, tornado-like winds or violent local rain.
* **The animals are small and light.** Tiny fish, tadpoles, frogs, insects and small invertebrates are more plausible cargo than large animals.
* **The fall is localised.** A narrow patch of animals fits a small vortex or rain cell better than a broad regional event.
* **A nearby source exists.** Ponds, drainage channels, floodwater and shallow lakes make the event less mysterious than an alleged long-distance fall from the sea.
* **Other debris appears too.** Leaves, mud, weed, silt or small stones can support a weather-transport explanation, even if witnesses focus on the animals.
...
## Coloured rain and dirty rain: strange falls without animals
...
## Spiders, insects and the problem of scale
...
This is a recurring pattern in Fortean weather cases. The witness’s description is not necessarily foolish; it is often a compressed account of what the scene felt like. “It rained spiders” may mean “spiders arrived from above or appeared everywhere after weather changed”. The literal and experiential meanings diverge, and [folklore]({{ 'folklore/' | relative_url }}) tends to preserve the more vivid version.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Includes unusual weather and natural phenomena.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Discusses unexplained weather-related reports.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Covers rains of animals and similar mysteries.</p>
        <div class="fr-book-actions">
