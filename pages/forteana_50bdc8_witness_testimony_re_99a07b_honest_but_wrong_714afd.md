...
show_ads: true
description: Sincerity can make a report worth hearing, but it does not turn memory into a replayable recording.
hero_summary: Sincerity can make a report worth hearing, but it does not turn memory into a replayable recording.
layout: default
permalink: /sincerity/
...
title: Can a Truthful Witness Still Be Mistaken?
title_full: Can a Truthful Witness Still Be Mistaken?
display_title_short: Sincerity
display_title: Sincerity
heading_title: Can a Truthful Witness Still Be Mistaken?
page_heading_title: Can a Truthful Witness Still Be Mistaken?
source_count: 28
infographic_count: 3
planned_sections:
- Sincerity and accuracy are different questions
- Stress, fear, and distorted recall
- Respectable witnesses and ordinary misidentification
...
next_link:
  ...
  heading_title: When the Intruder Is Felt in Bed
header:
  og_image: /assets/images/forteana_50bdc8_witness_testimony_re_99a07b_honest_but_wrong_714afd-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_witness_testimony_re_99a07b_honest_but_wrong_714afd-Illustration-1.webp
image: /assets/images/forteana_50bdc8_witness_testimony_re_99a07b_honest_but_wrong_714afd-Illustration-1-social.jpg
---
...
This distinction matters because many reports of unexplained lights, mysterious creatures or other anomalous experiences rely almost entirely on personal testimony. The credibility of the witness deserves respect, but the reliability of a specific recollection must be assessed separately. A truthful person may accurately report what they believe they experienced while still misremembering important details or misinterpreting what they saw.
...
In Fortean cases this distinction is especially important because witnesses are often trying to describe events unlike anything they have previously encountered. When the brain lacks an obvious category, it naturally fills gaps using familiar concepts. A witness may therefore describe a "craft", "creature" or "ghost" when the original perception was simply an unfamiliar shape, movement or sound.

## How stress and fear reshape recall

Unusual experiences frequently occur under conditions that are already unfavourable for accurate perception. Darkness, surprise, distance, poor [weather]({{ 'weather/' | relative_url }}) and emotional shock all reduce the quality of the original [observation]({{ 'observation/' | relative_url }}) before memory even begins to reconstruct it.
...
This helps explain why reports may contain striking certainty about one feature alongside uncertainty about others without implying dishonesty.
...
### Surprise encourages rapid interpretation

Humans rapidly interpret incomplete information because quick decisions are usually more useful than prolonged uncertainty.

A brief glimpse through trees, a moving shadow or an unfamiliar sound often forces the brain to choose the closest available explanation before sufficient evidence exists. Once an interpretation has formed, later recollections frequently preserve that interpretation rather than the raw sensory information.

Consequently, witnesses may honestly report, "I saw a large animal standing upright," when their original perception consisted of only a few seconds of movement under poor viewing conditions.

### Memory changes after the event
...
* Discussion with other witnesses before independent statements are recorded.
* Media coverage suggesting particular explanations.
* Reading internet discussions that introduce details absent from the original account.
* Repeated interviews that unintentionally encourage elaboration.

</div>

None of these mechanisms require deliberate fabrication.


<img src="{{ "/assets/images/forteana_50bdc8_witness_testimony_re_99a07b_honest_but_wrong_714afd-Illustration-2-dark.svg" | relative_url }}" alt="Sincerity illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_witness_testimony_re_99a07b_honest_but_wrong_714afd-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_witness_testimony_re_99a07b_honest_but_wrong_714afd-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Respectable witnesses can still misidentify ordinary events

Appeals to authority are common in Fortean discussions. Reports often emphasise that witnesses were police officers, pilots, scientists, military personnel or experienced outdoors enthusiasts. Such backgrounds may increase confidence that the witness tried to observe carefully, but they do not eliminate the limits of human perception.
...
## Why character evidence cannot settle extraordinary claims

One persistent misunderstanding in Fortean debates is the assumption that questioning a report necessarily means accusing the witness of lying.

These are different claims.

A witness can simultaneously be:
...
* Careful.
* Emotionally sincere.
* Mistaken about some aspect of what was perceived.

</div>

Likewise, discovering a conventional explanation for an event does not imply bad faith on the witness's part. A sincere observer can misidentify a rare atmospheric display, an astronomical object, an unusual animal or an unfamiliar aircraft without behaving irrationally.

Separating honesty from accuracy also protects genuinely unusual reports from weak reasoning. If every sincere testimony were accepted automatically, there would be no reliable way to distinguish genuinely unexplained events from ordinary misidentifications.
...
## A better way to assess strange-event testimony

The most useful question is not, "Do I believe the witness?" but, "How reliable is this particular memory under these particular circumstances?"

Investigators therefore look for factors that strengthen or weaken a report independently of the witness's character, including:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* How soon the account was recorded after the event.
* Whether witnesses gave independent statements before discussing what happened.
* Lighting, distance and viewing conditions.
* Duration of the observation.
* Whether descriptions remained stable across interviews.
* Whether physical evidence or independent observations support the testimony.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Supports careful evaluation of extraordinary testimony.</p>
        <div class="fr-book-actions">
