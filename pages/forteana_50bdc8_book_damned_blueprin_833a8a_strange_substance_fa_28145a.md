...
show_ads: true
description: Fort used reports of uncanny rain and falling matter to test the limits of ordinary weather explanation.
hero_summary: Fort used reports of uncanny rain and falling matter to test the limits of ordinary weather explanation.
layout: default
permalink: /strange-rain/
sidebar_expanded_urls:
- /forteana/
- /damned-book/
nav_short_title: Strange Rain
title: When Rain Looked Too Strange to Explain
title_full: When Rain Looked Too Strange to Explain
display_title_short: Strange Rain
display_title: Strange Rain
heading_title: When Rain Looked Too Strange to Explain
page_heading_title: When Rain Looked Too Strange to Explain
source_count: 15
infographic_count: 3
planned_sections:
- Blood like rain in Fortean files
- Weather, error, hoax, or residue
- Why substance falls suited Fort's method
...
next_link:
  ...
  heading_title: Why Fortean Vanishings Feel Different
header:
  og_image: /assets/images/forteana_50bdc8_book_damned_blueprin_833a8a_strange_substance_fa_28145a-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_book_damned_blueprin_833a8a_strange_substance_fa_28145a-Illustration-1.webp
image: /assets/images/forteana_50bdc8_book_damned_blueprin_833a8a_strange_substance_fa_28145a-Illustration-1-social.jpg
---
...
Within the wider Fortean tradition, strange rain became one of the clearest demonstrations of Fort's method. A report of crimson rain, black dust or mysterious slime could rarely be repeated under controlled conditions, yet such events appeared often enough in [newspapers]({{ 'newspapers/' | relative_url }}), weather records and scientific correspondence to resist simple [dismissal]({{ 'dismissal/' | relative_url }}). The resulting tension—between eyewitness testimony, imperfect evidence and competing explanations—remains one of the defining features of Fortean thinking.
...
The cases varied considerably:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Rainwater reported as bright red or dark crimson.
* Localised showers staining buildings, vegetation or clothing.
* Deposits of reddish dust accompanying rainfall.
* Reports where witnesses initially believed actual blood had fallen.

</div>

Fort rarely insisted that the substance genuinely was blood. Instead, he highlighted how observers and investigators often reached radically different conclusions despite examining the same event.
...
Modern meteorology provides several well-established mechanisms that explain many historical reports without requiring unknown atmospheric phenomena.

Red or blood-like rain is now commonly understood to result from microscopic particles suspended in rainwater. These may include:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Windblown desert dust carried hundreds or even thousands of kilometres through the atmosphere.
* Spores or algae containing red pigments.
* Fine mineral particles mixed into rain clouds before precipitation.
...
Fort considered that uncertainty itself significant. He argued that uncertainty should encourage investigation rather than immediate exclusion.


<img src="{{ "/assets/images/forteana_50bdc8_book_damned_blueprin_833a8a_strange_substance_fa_28145a-Illustration-2-dark.svg" | relative_url }}" alt="Strange Rain illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_book_damned_blueprin_833a8a_strange_substance_fa_28145a-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_book_damned_blueprin_833a8a_strange_substance_fa_28145a-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## More than red rain: the catalogue of strange falls

Although blood-like rain attracted attention because of its dramatic appearance, Fort placed it within a broader category of anomalous falls. Throughout *The Book of the Damned*, he assembled reports describing substances that seemed equally difficult to classify.

Examples included alleged falls of:

* Black dust or soot covering large areas.
* Yellow powders resembling pollen.
* Fibrous material described as hair-like or woolly.
...
Reports of strange substances falling from the sky perfectly matched Fort's broader argument about "damned" facts.

Unlike spectacular claims that required belief in entirely new forces of nature, coloured rain and mysterious deposits occupied an uncomfortable middle ground. They were:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Usually reported by ordinary witnesses rather than professional paranormal investigators.
* Sometimes accompanied by physical material that could be examined.
* Occasionally mentioned in scientific journals before being dismissed.
* Difficult to repeat experimentally.
...
However, they do not entirely eliminate the historical interest of Fort's collection. His enduring contribution lies less in demonstrating that extraordinary substances truly fell from the sky than in documenting how observations moved between eyewitness testimony, journalism, scientific investigation and official rejection. Some reports proved explicable; others remain too poorly documented to assess. Together they illustrate the uncertain boundary between anomaly and explanation that fascinated Fort.

For readers of *The Book of the Damned*, strange rain therefore functions as more than an atmospheric curiosity. It exemplifies the book's larger challenge: not that conventional science is necessarily wrong, but that the path from observation to accepted explanation is often more complicated—and more revealing—than either believers or sceptics may wish to admit.
...
<article class="fr-book-card">
<a class="fr-book-cover" href="https://www.amazon.com/s?k=Rain%3A+A+Natural+and+Cultural+History+Cynthia+Barnett&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open Rain: A Natural and Cultural History on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://covers.openlibrary.org/b/id/12757592-M.jpg" alt="Cover for Rain: A Natural and Cultural History" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
<div class="fr-book-info">
<h4 class="fr-book-title">
<a href="https://www.amazon.com/s?k=Rain%3A+A+Natural+and+Cultural+History+Cynthia+Barnett&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="Rain: A Natural and Cultural History">Rain: A Natural and Cultural History</a>
</h4>
<p class="fr-book-author">By Cynthia Barnett</p>
        
<p class="fr-book-desc">Provides scientific and historical context for unusual rainfall.</p>
<div class="fr-book-actions">
<a href="https://www.amazon.com/s?k=Rain%3A+A+Natural+and+Cultural+History+Cynthia+Barnett&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
</a>
</div>
</div>
...
<p class="fr-book-desc">Includes accounts of mysterious falls and atmospheric anomalies.</p>
<div class="fr-book-actions">
