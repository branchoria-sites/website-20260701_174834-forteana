...
show_ads: true
description: Some animal falls may begin on the ground, where flooded drains, saturated soil, and wet-weather migration create sudden appearances.
hero_summary: Some animal falls may begin on the ground, where flooded drains, saturated soil, and wet-weather migration create sudden appearances.
layout: default
permalink: /not-falling/
sidebar_expanded_urls:
- /forteana/
- /animal-falls/
nav_short_title: Not Falling
title: When Animal Rain Did Not Fall
title_full: When Animal Rain Did Not Fall
display_title_short: Not Falling
display_title: Not Falling
heading_title: When Animal Rain Did Not Fall
page_heading_title: When Animal Rain Did Not Fall
source_count: 25
infographic_count: 3
planned_sections:
- Floodwater, drains, and roadside deposits
- Frogs and worms moving after rain
- Clues that separate falls from appearances
...
next_link:
  ...
  heading_title: Why Do Animal Falls Look So Selective?
header:
  og_image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_mistaken_animal_rain_8f8706-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_mistaken_animal_rain_8f8706-Illustration-1.webp
image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_mistaken_animal_rain_8f8706-Illustration-1-social.jpg
---
...
Heavy rainfall can rapidly redistribute small animals without lifting them into the atmosphere. Urban drainage networks, roadside ditches, streams and flooded fields act as temporary transport systems. As water levels rise, fish may escape from ponds into overflow channels, tadpoles can be washed downstream, and aquatic invertebrates may accumulate wherever floodwater slows or recedes.
...
* saturated soil changes oxygen availability for some species;
* wet surfaces allow safer overland travel without desiccation;
* rain-related vibrations or other environmental cues may stimulate emergence in certain circumstances.
...
## Why these events resemble animal rain

Several psychological and observational factors make overland movement easy to mistake for [falling animals]({{ 'falling-animals/' | relative_url }}).

First, people usually witness the aftermath rather than the movement itself. Rain reduces visibility, encourages people to remain indoors and masks gradual animal dispersal. When the weather clears, the animals are already scattered across streets or gardens.

Second, rainfall provides an obvious narrative link. If animals are first noticed during or immediately after a storm, it is natural to connect the two events by assuming they descended with the rain.
...
Investigators evaluating alleged animal rains look for practical clues that distinguish genuine aerial deposition from ground-level redistribution.

Evidence favouring ordinary flooding or overland movement includes:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* animals concentrated beside drains, culverts, streams or flood channels;
* obvious recent flooding connecting ponds or wetlands to the discovery site;
* live amphibians actively hopping or crawling away rather than lying where they supposedly landed;
* worms or amphibians appearing over several hours as rain continues;
* observations confined to roads, pavements and gardens rather than roofs, elevated structures or enclosed spaces.

</div>

Evidence that would strengthen the case for an actual atmospheric fall includes:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* multiple independent witnesses seeing animals descend through the air;
* animals found on rooftops, elevated decks or isolated surfaces difficult to reach by crawling or flowing water;
* deposition patterns inconsistent with local drainage or flooding;
* weather conditions capable of producing powerful storm updraughts.
...
## Why this explanation matters in Forteana
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly supports evaluating mistaken explanations.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides comparative cases and interpretations.</p>
        <div class="fr-book-actions">
