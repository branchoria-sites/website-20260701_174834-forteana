...
- forteana_50bdc8_ghost_reports_memory_fdf4a4_index
...
show_ads: true
description: Haunting stories often mix place, grief, sleep, fraud, architecture, and genuine uncertainty.
hero_summary: Haunting stories often mix place, grief, sleep, fraud, architecture, and genuine uncertainty.
layout: default
permalink: /ghosts/
sidebar_expanded_urls:
- /forteana/
nav_short_title: Ghosts
title: What Makes a Ghost Story Fortean?
title_full: What Makes a Ghost Story Fortean?
display_title_short: Ghosts
display_title: Ghosts
heading_title: What Makes a Ghost Story Fortean?
page_heading_title: What Makes a Ghost Story Fortean?
source_count: 158
infographic_count: 3
planned_sections:
- The reported experience
- Ordinary explanations to test
- How places become haunted
...
next_link:
  ...
  heading_title: How Hoaxes Shape the Fortean Record
header:
  og_image: /assets/images/forteana_50bdc8_ghost_reports_memory_fdf4a4-overview-social.jpg
  preview_image: /assets/images/forteana_50bdc8_ghost_reports_memory_fdf4a4-overview.webp
image: /assets/images/forteana_50bdc8_ghost_reports_memory_fdf4a4-overview-social.jpg
---

## Introduction

A ghost story becomes Fortean when it is treated not simply as entertainment or proof, but as a report to be examined: who saw what, under what conditions, what the place already meant, and how the story changed as it was retold. Haunting reports sit in the awkward middle ground between [folklore]({{ 'folklore/' | relative_url }}), [witness memory]({{ 'witness-memory/' | relative_url }}), grief, architecture, environmental discomfort, fraud, and events that remain personally powerful even when they are not externally verified.
...
* **Single apparition:** a figure, voice or presence seen once, often in liminal conditions such as darkness, illness, fatigue, grief or waking from sleep.
* **Repeated haunting:** sounds, sensations or sightings attached to a building, room, road, ruin or landscape.
* **Crisis or bereavement encounter:** a felt contact with someone dying or already dead, often interpreted through family memory rather than local legend.
* **Poltergeist-style disturbance:** knocks, object movement, electrical oddities or apparent physical effects, often involving households under stress.
* **Reputation-led experience:** an uneasy feeling or ambiguous perception in a place already labelled haunted.
...
## Why witness memory is not the same as witness honesty
...
This does not make the experience worthless. It changes the question. Instead of asking only, “Did a ghost appear?”, a Fortean investigator asks:


<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. What was recorded before the witness heard local lore?
2. Were accounts written independently or after group discussion?
3. Did the witness describe perception first and interpretation second?
4. Did later retellings add detail, confidence or narrative structure?
5. Are there physical, medical, architectural or social conditions that match the report?

</div>

The most valuable ghost testimony is usually early, specific, boring in parts, and resistant to dramatic improvement. The more a report becomes polished into a perfect legend, the harder it is to separate memory from folklore.
...
The strongest Fortean handling of ghost reports does not begin with debunking. It begins with controls. A claim becomes more interesting, not less, when obvious explanations have been tested carefully and recorded fairly.
...
### Sound, vibration and old buildings
...
<img src="{{ "/assets/images/forteana_50bdc8_ghost_reports_memory_fdf4a4-Illustration-2-dark.svg" | relative_url }}" alt="Ghosts illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_ghost_reports_memory_fdf4a4-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_ghost_reports_memory_fdf4a4-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Fraud, performance and social reward
...
* **A striking setting** gives people sensory material: darkness, echoes, draughts, isolation.
* **A wound or mystery** gives the story emotional force: murder, grief, plague, betrayal, disappearance, injustice.
* **A repeated script** gives later witnesses something to recognise: the grey lady, the monk, the child, the footsteps, the room no one likes.
* **A public channel** spreads the account: [newspapers]({{ 'newspapers/' | relative_url }}), guidebooks, ghost walks, documentaries, podcasts, TikTok, horror films.
* **A feedback loop** develops: visitors arrive expecting a ghost, report ambiguous sensations, and those reports strengthen the site’s reputation.

This does not make haunted places fake in a simple sense. It means their haunting is partly social. The place teaches people how to experience it.
...
## Cases that show the Fortean problem
...
## What makes a ghost story Fortean?

A ghost story is Fortean when it remains open to examination rather than being flattened into belief or ridicule. The question is not only whether a dead person returned. It is how a reported experience moved from perception to memory, from memory to story, and from story to place reputation.

The most Fortean ghost reports usually have several features:


<div class="content-enhancement content-enhancement--checklist" markdown="1">

* **A specific witness claim:** not merely “people say”, but a describable event tied to time, place and observer.
* **Ambiguous but persistent evidence:** enough detail to examine, not enough to settle cleanly.
* **A charged setting:** a house, ruin, road, institution or landscape already carrying emotional or historical weight.
* **Competing explanations:** sleep, grief, fraud, architecture, suggestion, environmental factors and cultural expectation all remain plausible enough to test.
* **A changing narrative trail:** early accounts, later retellings and public versions do not always match.

</div>

The weakest reports are often the most cinematic: perfect apparitions, theatrical backstories, no mundane detail, no independent chronology, and evidence that grows more elaborate with each retelling. The strongest reports are often stranger in a quieter way: a confused [first account]({{ 'first-account/' | relative_url }}), a witness who is not trying to sell a story, a physical setting that can be inspected, and details that resist both easy paranormal and easy sceptical closure.
...
<p class="fr-book-desc">Explores critical investigation of ghost claims rather than simple belief.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Shows how ghost narratives evolve through folklore and retelling.</p>
<div class="fr-book-actions">
