...
show_ads: true
description: Some fish falls may come from startled birds dropping or regurgitating fish rather than from a waterspout.
hero_summary: Some fish falls may come from startled birds dropping or regurgitating fish rather than from a waterspout.
layout: default
permalink: /bird-drops/
sidebar_expanded_urls:
- /forteana/
- /weather/
nav_short_title: Bird Drops
title: When Birds Explain Falling Fish
title_full: When Birds Explain Falling Fish
display_title_short: Bird Drops
display_title: Bird Drops
heading_title: When Birds Explain Falling Fish
page_heading_title: When Birds Explain Falling Fish
source_count: 26
infographic_count: 3
planned_sections:
- How birds carry and expel fish
- Why storms can trigger sudden drops
- Signs of digestion, flocking and local sources
...
next_link:
  ...
  heading_title: The Debris That Makes Animal Falls Believable
header:
  og_image: /assets/images/forteana_50bdc8_weather_strange_fall_4c1363_bird_fish_drops_4b7bad-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_weather_strange_fall_4c1363_bird_fish_drops_4b7bad-Illustration-1.webp
image: /assets/images/forteana_50bdc8_weather_strange_fall_4c1363_bird_fish_drops_4b7bad-Illustration-1-social.jpg
---
...
Storms create several conditions that increase the likelihood of birds dropping prey without requiring the fish themselves to have been lifted by the weather.
...
* **Sudden flushing from roosts.** Thunder, lightning, hail or strong gusts can startle birds into rapid take-off before they have finished handling prey.
* **Loss of flight control.** Turbulence makes carrying heavy or slippery fish more difficult.
* **Predator and scavenger interactions.** Storms may concentrate birds into smaller areas, increasing harassment by gulls or other birds attempting to steal food.
* **Stress-induced regurgitation.** Birds sometimes eject stomach contents to reduce weight or as a physiological response to sudden disturbance.
...
## Signs that point towards a bird origin

Several clues can distinguish bird drops from a genuine weather-transport event.

A bird explanation becomes more convincing when observers find:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* only a few fish rather than hundreds;
...
## A modern example: the Texarkana fish fall
...
## Why this explanation matters in Fortean investigations

Within [Forteana]({{ 'forteana/' | relative_url }}), bird drops demonstrate why investigators benefit from separating the appearance of an event from its mechanism. Discovering fish after a thunderstorm naturally encourages people to connect the fish directly with the storm. Yet storms also disturb animal behaviour, creating opportunities for perfectly ordinary biological processes to produce extraordinary-looking scenes.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Includes unusual natural events.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Includes famous fish-fall stories.</p>
        <div class="fr-book-actions">
