...
- forteana_50bdc8_uncanny_coincidences_4f1cf2_index
...
show_ads: true
description: Uncanny coincidences show how probability, memory, selection, and storytelling can make chance feel designed.
hero_summary: Uncanny coincidences show how probability, memory, selection, and storytelling can make chance feel designed.
layout: default
permalink: /coincidences/
sidebar_expanded_urls:
- /forteana/
nav_short_title: Coincidences
title: Why Do Some Coincidences Feel Impossible?
title_full: Why Do Some Coincidences Feel Impossible?
display_title_short: Coincidences
display_title: Coincidences
heading_title: Why Do Some Coincidences Feel Impossible?
page_heading_title: Why Do Some Coincidences Feel Impossible?
source_count: 111
infographic_count: 3
planned_sections:
- What makes a coincidence uncanny
- Probability and selective attention
...
next_link:
  ...
  heading_title: What Explains Spontaneous Human Combustion Claims?
header:
  og_image: /assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-overview-social.jpg
  preview_image: /assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-overview.webp
image: /assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-overview-social.jpg
---

## Introduction

Some coincidences feel impossible because the mind experiences them as small plots: a thought and a [phone call]({{ 'phone-call/' | relative_url }}), a name repeated three times in a day, a dream that seems to echo tomorrow’s news. In [Forteana]({{ 'forteana/' | relative_url }}), these stories matter because they sit at the border between chance and meaning. They do not have to prove telepathy, fate or hidden design to be worth examining. Their power comes from a recognisable human problem: we are good at noticing patterns, poor at estimating how many possible patterns could have happened, and inclined to retell the striking “hits” while forgetting the uneventful misses.
...
## Probability is larger than intuition
...
This is why a coincidence can be genuinely rare in its final form and still not be evidence of design. The final form is often selected after the fact. A dream did not have to match exactly; it only had to resemble some later event. A number did not have to recur in one precise place; it could recur on a receipt, clock, address, train platform, phone number or news report. Once the target can move, the odds change dramatically.
...
This matters for Forteana because many coincidence claims are built from attention shifts. A symbol, number, animal or phrase becomes personally salient, and then the mind scans for it more efficiently. The resulting experience can feel external and uncanny: “It is following me.” But the mechanism may be internal and ordinary: “I am now tuned to notice it.”

Selective attention does not make the experience fake. The car really is on the road; the word really is in the article; the repeated number really is on the ticket. What changes is the meaning assigned to the recurrence. The event is real, but its apparent impossibility may come from failing to count all the times the world offered possible matches and none were noticed.


<img src="{{ "/assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-Illustration-2-dark.svg" | relative_url }}" alt="Coincidences illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Memory keeps the hits and drops the misses
...
This is one reason older coincidence anecdotes are hard to assess. Many are not frauds; they are polished memories. The further a story travels from a dated record, the more difficult it becomes to know which details were present before the coincidence was noticed and which were added because the coincidence made the story worth telling.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/RBG_T-KUvj0" title="The Mathematics of Coincidence - Sarah Hart" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=RBG_T-KUvj0" target="_blank" rel="noopener noreferrer">The Mathematics of Coincidence - Sarah Hart</a></p><p class="youtube-embed-meta">Channel: Gresham College</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=RBG_T-KUvj0" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=RBG_T-KUvj0">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-Illustration-3-dark.svg" | relative_url }}" alt="Coincidences illustration 3" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_uncanny_coincidences_4f1cf2-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How to read an impossible coincidence

The most useful test is not “Could this have happened by chance?” Almost anything could, given enough opportunities. A better question is: “What would I have counted as a hit before I knew the outcome?”

A careful reading asks:

* **Was the target specified in advance?** A prediction written down beforehand is stronger than a remembered feeling matched later to events.
* **How many possible matches were available?** Names, dates, places, symbols and near-matches multiply the opportunities for coincidence.
* **Are misses being counted?** A fair assessment includes the dreams, thoughts, hunches and repeated numbers that did not lead anywhere.
* **Could there be a hidden cause?** Shared routines, mutual friends, media exposure, algorithms, anniversaries and local events can create patterns that feel independent.
* **Has the story been cleaned up?** [Retellings]({{ 'retellings/' | relative_url }}) often remove uncertainty and strengthen resemblance.

These questions do not kill wonder. They clarify what kind of wonder is involved. Some coincidences are wonderful because they reveal how vast the web of ordinary life is. Others are wonderful because they show how quickly the mind makes meaning. A few may remain genuinely puzzling because the records are unusually good and the ordinary explanations are weak. But “puzzling” is not the same as “impossible”.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/QwIQa3bVqRY" title="Synchronicity - The Hidden Meaning of Coincidences" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=QwIQa3bVqRY" target="_blank" rel="noopener noreferrer">Synchronicity - The Hidden Meaning of Coincidences</a></p><p class="youtube-embed-meta">Channel: Mirror</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=QwIQa3bVqRY" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=QwIQa3bVqRY">Open on YouTube</a></p></div></div></div>

## Why coincidences belong in Forteana

Coincidences fit naturally within Forteana because they expose the central Fortean tension: the world keeps producing events that feel arranged, while evidence often points back to probability, perception and narrative. They are anomalies of interpretation as much as anomalies of fact.

Unlike a cryptid sighting or a mysterious light in the sky, a coincidence may require no disputed physical event. The phone call happened. The name appeared. The shared birthday is real. The strangeness lies in the relationship drawn between events. That makes coincidence one of the cleanest Fortean subjects: it shows how mystery can arise not only from what happens, but from how events are grouped.

The strongest lesson is not that all coincidences are meaningless. It is that meaning and evidence are different things. A coincidence can be personally significant, culturally durable and emotionally vivid without overturning probability. It can also be a prompt to investigate: perhaps there is a hidden cause, a forgotten connection, a social network link, an algorithmic nudge or a genuine statistical anomaly worth testing.
