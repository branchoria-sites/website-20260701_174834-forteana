...
show_ads: true
description: Honest witnesses can misread ambiguous events, so a careful page separates sincerity, memory, and external evidence.
hero_summary: Honest witnesses can misread ambiguous events, so a careful page separates sincerity, memory, and external evidence.
layout: default
...
- How memory changes strange reports
...
prev_link:
  ...
  heading_title: Unidentified Is Not the Same as Alien
header:
  og_image: /assets/images/forteana_50bdc8_skepticism_without_d_bca821_witness_sincerity_me_9f0c73-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_skepticism_without_d_bca821_witness_sincerity_me_9f0c73-Illustration-1.webp
image: /assets/images/forteana_50bdc8_skepticism_without_d_bca821_witness_sincerity_me_9f0c73-Illustration-1-social.jpg
---

## Introduction

Many Fortean accounts begin with a person describing something they genuinely believe they experienced. That [sincerity]({{ 'sincerity/' | relative_url }}) deserves respect, but it is not the same thing as independent evidence that the event occurred exactly as remembered. A careful investigator can accept that a witness is being honest while still asking whether perception, memory, later discussion, or missing context may have altered the account. This distinction is central to scepticism without [dismissal]({{ 'dismissal/' | relative_url }}): it protects witnesses from unfair accusations of deceit while protecting investigations from treating memory itself as proof.
...
A sincere witness answers one question: whether they are honestly reporting what they believe they experienced. It does not answer another, separate question: whether their recollection perfectly matches an external event.

In Fortean investigations these questions are often blurred together. If someone reports an unexplained light, an apparition, or an unfamiliar animal, listeners may jump immediately to one of two extremes. They either conclude that the witness must be mistaken or dishonest, or they assume honesty proves the extraordinary interpretation. Neither conclusion follows logically.

Instead, investigators benefit from separating three distinct possibilities:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* **The witness is deliberately inventing the story.**
* **The witness experienced something genuine but misunderstood what caused it.**
* **The witness accurately perceived an event that remains unexplained.**
...
Memory is an active reconstruction rather than a stored video recording. Every recall involves rebuilding an event from fragments, expectations and later knowledge. That reconstruction is usually good enough for everyday life but becomes more vulnerable when the original [experience]({{ 'experience/' | relative_url }}) was brief, surprising or ambiguous.

For Fortean reports, several well-established mechanisms are especially relevant.

### Ambiguous events invite interpretation

Many unusual experiences occur under poor viewing conditions: distant lights, darkness, fog, fleeting movement or unexpected sounds. When sensory information is incomplete, the brain naturally fills gaps using prior knowledge and expectations.
...
### Memories absorb later information
...
* the earliest recorded account;
* later expanded versions;
* interpretations added after publicity;
* [folklore]({{ 'folklore/' | relative_url }}) or community traditions that become attached to the report.

The earliest documentation often preserves valuable uncertainty that later [retellings]({{ 'retellings/' | relative_url }}) smooth away.
...
### Confidence grows more easily than accuracy
...
Treating witnesses respectfully does not require accepting every conclusion they draw. In fact, neutral interviewing often preserves better evidence than enthusiastic agreement or aggressive scepticism.

Useful questions focus first on [observation]({{ 'observation/' | relative_url }}) before interpretation.

Instead of asking, "Do you think it was paranormal?", an investigator might ask:
...
* Approximately how long did the event last?
* What drew your attention?
* When did you first write or tell someone about it?
* Did you discuss it with other witnesses before recording your own account?
...
## A Fortean approach to testimony

Within [Forteana]({{ 'forteana/' | relative_url }}), witness testimony often represents the starting point rather than the conclusion of an investigation. A compelling report can identify an event worth examining even when it cannot establish what objectively occurred.

This perspective also explains why many classic cases remain debated for decades. The testimony may be entirely genuine while the surviving physical evidence is sparse, contradictory or absent. Rather than forcing certainty, careful investigators separate the documented experience from later interpretations.

The most useful question therefore becomes neither "Did the witness lie?" nor "Should we believe them?" Instead it is: "What does this testimony reliably establish, and where does memory end and independent evidence begin?"

That distinction allows sincere witnesses to be treated with dignity while keeping extraordinary conclusions tied to evidence that can be examined beyond memory alone.
...
<p class="fr-book-desc">Directly addresses the reliability of eyewitness recollection.</p>
<div class="fr-book-actions">
