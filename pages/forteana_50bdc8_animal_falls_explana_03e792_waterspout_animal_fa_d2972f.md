...
show_ads: true
description: Waterspouts can plausibly lift small animals, but the mechanism works best under narrow weather, distance, and evidence conditions.
hero_summary: Waterspouts can plausibly lift small animals, but the mechanism works best under narrow weather, distance, and evidence conditions.
layout: default
permalink: /waterspouts/
sidebar_expanded_urls:
- /forteana/
- /animal-falls/
nav_short_title: Waterspouts
title: Can Waterspouts Really Lift Fish?
title_full: Can Waterspouts Really Lift Fish?
display_title_short: Waterspouts
display_title: Waterspouts
heading_title: Can Waterspouts Really Lift Fish?
page_heading_title: Can Waterspouts Really Lift Fish?
source_count: 28
infographic_count: 3
planned_sections:
- Tornadic versus fair weather waterspouts
- What storm uplift can and cannot explain
- Evidence checks before accepting the claim
...
prev_link:
  ...
  heading_title: Did Fish Really Rain on Texarkana?
header:
  og_image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_waterspout_animal_fa_d2972f-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_waterspout_animal_fa_d2972f-Illustration-1.webp
image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_waterspout_animal_fa_d2972f-Illustration-1-social.jpg
---
...
Within Fortean studies, this distinction matters. Accepting that some animal falls have a natural meteorological cause does not mean every reported event shares that origin. The strength of the waterspout explanation depends on whether the evidence matches the known behaviour of severe storms.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/Bu2C1y03uyo" title="Waterspouts" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=Bu2C1y03uyo" target="_blank" rel="noopener noreferrer">Waterspouts</a></p><p class="youtube-embed-meta">Channel: usoceangov</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=Bu2C1y03uyo" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=Bu2C1y03uyo">Open on YouTube</a></p></div></div></div>

## Tornadic versus fair-weather waterspouts

Not all waterspouts are equally capable of transporting animals.
...
The waterspout hypothesis works best under fairly specific conditions.

It is most convincing when:

* the animals are small and lightweight;
* they normally live close to the water surface;
* the deposit occurs shortly after severe weather;
* there is a plausible nearby source such as a pond, river, lake or coastline;
* the animals belong largely to [one species]({{ 'one-species/' | relative_url }}) or similar size class.
...
Waterspouts are poor explanations for reports involving:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* large mammals or other heavy animals;
* species with no plausible nearby aquatic habitat;
* deposits occurring without any evidence of recent convective storms;
* isolated animals appearing over very large regions simultaneously.
...
A convincing waterspout explanation depends on more than the existence of unusual weather.

Investigators typically ask several practical questions.

**Was there suitable weather?** Severe thunderstorms, radar signatures, tornado reports or documented waterspouts strengthen the case. Ordinary rainfall alone does not.

**Where is the nearest source population?** The closer an appropriate pond, estuary, reservoir or coastline lies to the reported fall, the more plausible storm transport becomes.

**What species were involved?** Accurate identification matters. Marine fish found inland suggest different possibilities from freshwater minnows found near rivers. [Misidentification]({{ 'mistakes/' | relative_url }}) can easily distort later retellings.
...
The strongest position is therefore a balanced one: waterspouts are a real atmospheric mechanism capable of producing genuine fish and frog falls under suitable conditions, but each reported event must be tested against the available meteorological, biological and geographical evidence rather than assumed to share the same origin.
