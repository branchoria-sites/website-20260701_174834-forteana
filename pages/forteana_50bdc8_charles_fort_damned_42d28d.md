...
- forteana_50bdc8_charles_fort_damned_42d28d_index
...
show_ads: true
description: Charles Fort turned rejected reports into a lasting challenge about who decides what counts as evidence.
hero_summary: Charles Fort turned rejected reports into a lasting challenge about who decides what counts as evidence.
layout: default
permalink: /charles-fort/
sidebar_expanded_urls:
- /forteana/
nav_short_title: Charles Fort
title: Why Charles Fort Still Haunts Strange Evidence
title_full: Why Charles Fort Still Haunts Strange Evidence
display_title_short: Charles Fort
display_title: Charles Fort
heading_title: Why Charles Fort Still Haunts Strange Evidence
page_heading_title: Why Charles Fort Still Haunts Strange Evidence
source_count: 76
infographic_count: 3
planned_sections:
- From journalist to anomaly collector
- The idea of damned facts
- What Fort got right and wrong
...
next_link:
  ...
  heading_title: Why Do Some Coincidences Feel Impossible?
header:
  og_image: /assets/images/forteana_50bdc8_charles_fort_damned_42d28d-overview-social.jpg
  preview_image: /assets/images/forteana_50bdc8_charles_fort_damned_42d28d-overview.webp
image: /assets/images/forteana_50bdc8_charles_fort_damned_42d28d-overview-social.jpg
---
...
That idea did not make Fort a reliable scientist, and it did not make every falling frog, strange light, poltergeist report or impossible-looking disappearance true. What it did was create a durable way of asking who gets to decide what counts as evidence. Fort’s legacy is therefore less a set of answers than a pressure test: when an [observation]({{ 'observation/' | relative_url }}) seems absurd, do we investigate it, explain it away, file it as [folklore]({{ 'folklore/' | relative_url }}), or refuse to see it at all?
...
Fort’s lasting challenge is that filtering can become circular. A report may be ignored because it is anomalous; then its lack of investigation is used as evidence that it was never worth investigating. The damned fact disappears twice: first from the official explanation, then from the memory of why it was excluded.

This is where Fort remains useful even to sceptical readers. He forces a distinction between “unexplained” and “true”, but also between “explained” and “properly examined”. A weak report should not be promoted into proof. Yet a weak explanation should not be promoted into closure simply because the alternative is uncomfortable.
...
Fort’s best insight was social rather than paranormal. He saw that evidence is not just discovered; it is admitted, classified, argued over and sometimes rejected by institutions. Modern readers do not have to accept his cosmic speculations to recognise that archives contain discarded observations, failed explanations and anomalies that later become meaningful.
...
<img src="{{ "/assets/images/forteana_50bdc8_charles_fort_damned_42d28d-Illustration-3-dark.svg" | relative_url }}" alt="Charles Fort illustration 3" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_charles_fort_damned_42d28d-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_charles_fort_damned_42d28d-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What Fort got wrong

Fort’s weaknesses are just as important as his insights. He often treated printed reports as if their survival in newspapers or journals gave them a kind of stubborn evidential dignity. But old reports can preserve [mistakes]({{ 'mistakes/' | relative_url }}) as easily as facts. A claim may be duplicated, mistranslated, exaggerated, stripped of context, or repeated from a bad original.
...
## Why Fort still haunts strange evidence
...
For modern readers, the strongest way to use Fort is neither credulous nor dismissive. A Fortean reading asks four questions at once: What was reported? How good is the chain of evidence? Why did the report become excluded? And what would count as a better explanation? Fort’s answer was often too theatrical. His question remains sharp.

## The useful Fort, not the infallible Fort

Charles Fort gave Forteana its name, its attitude and its central irritant: the suspicion that some facts are damned before they are heard. But his work is most valuable when read as provocation, not proof. He was a brilliant collector of awkward reports, a satirist of intellectual arrogance and a poor model for careful verification.
