...
show_ads: true
description: 'Forteana is the loose field of stories, reports and arguments that cluster around strange events which seem to fall between accepted categories: fish or...'
hero_summary: 'Forteana is the loose field of stories, reports and arguments that cluster around strange events which seem to fall between accepted categories: fish or frogs said to fall from the sky, ghostly figures, cryptids, unusual aerial sightings, uncanny coincidences, miraculous claims, and other anomalies that are reported often enough to be culturally...'
layout: default
permalink: /forteana/
nav_short_title: Forteana
title: Forteana
title_full: Forteana
display_title_short: Forteana
display_title: Forteana
source_count: 94
infographic_count: 3
page_website_name: Forteana
page_banner_line: Strange reports, careful doubt, and the stories that refuse to settle.
site_website_name: Forteana
site_banner_line: Strange reports, careful doubt, and the stories that refuse to settle.
...
header:
  ...
  preview_image: /assets/images/forteana_50bdc8-overview.webp
...
## Forteana, science and scepticism
...
* **What exactly was reported?** Strip the case back to the earliest available account, not the later legend.
* **Who reported it, and through what channel?** A police statement, local newspaper item, memoir and online retelling do not carry equal weight.
* **What ordinary explanations fit the details?** Weather, animals, hoaxes, [misidentification]({{ 'mistakes/' | relative_url }}), memory and media amplification often explain more than first appears.
* **What remains genuinely unresolved?** “Unexplained” should mean not yet adequately explained, not automatically paranormal.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/Ffs9wW_Rj2c" title="How Science Resists Knowledge of Anomalies | Ron Westrum" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=Ffs9wW_Rj2c" target="_blank" rel="noopener noreferrer">How Science Resists Knowledge of Anomalies | Ron Westrum</a></p><p class="youtube-embed-meta">Channel: Society for Scientific Exploration</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=Ffs9wW_Rj2c" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=Ffs9wW_Rj2c">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/forteana_50bdc8-Illustration-2-dark.svg" | relative_url }}" alt="Forteana illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How to read a Fortean claim without being fooled

The best reader of Forteana needs two instincts that often pull in opposite directions: curiosity and restraint. Curiosity prevents premature dismissal; restraint prevents a mystery from becoming a belief system.

A useful reading strategy is to separate the claim into layers:


<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. **The event layer:** what allegedly happened, where, and when.
2. **The evidence layer:** the earliest documents, witnesses, photographs, samples, measurements or official records.
3. **The interpretation layer:** what people later claimed the event meant.
4. **The folklore layer:** how the story changed as it was retold.
5. **The incentive layer:** who benefits from a dramatic version: publishers, tourism boards, hoaxers, campaigners, sceptics or believers.

</div>

This approach keeps Forteana interesting without surrendering judgement. A monster sighting may turn out to be an owl, a crane, a hoax or an unresolved witness report. A ghost may become a study in sleep paralysis, grief or architecture. A strange fall may be a weather event. A UFO report may involve misidentified aircraft, astronomical objects, military secrecy or genuinely insufficient data. The point is not to drain all wonder from the world; it is to avoid replacing one lazy answer with another.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/SelOdzppZ_g" title="Dinsdale Award Lecture | Jerome Clark" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=SelOdzppZ_g" target="_blank" rel="noopener noreferrer">Dinsdale Award Lecture | Jerome Clark</a></p><p class="youtube-embed-meta">Channel: Society for Scientific Exploration</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=SelOdzppZ_g" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=SelOdzppZ_g">Open on YouTube</a></p></div></div></div>

## Why Forteana still matters

Forteana remains relevant because modern life has not become less strange. If anything, the internet has made anomaly culture faster, louder and harder to sort. Eyewitness clips, conspiracy claims, local legends, declassified documents, folklore revivals and AI-generated fakery now circulate together. The old Fortean problem — how to handle reports that do not fit — has become a mainstream information problem.

Fort’s own answers were often eccentric, but his central irritation still has force: knowledge systems are human systems, and they can miss things, misclassify things or quietly discard inconvenient observations. At the same time, the history of Forteana shows the opposite danger just as clearly. A rejected claim is not automatically a suppressed truth. Some “damned” facts are simply bad facts. Some are jokes. Some are folklore. Some are rare natural events. Some are still unresolved because the evidence is gone.

That is the enduring value of Forteana: it teaches a disciplined comfort with uncertainty. It invites readers to notice odd reports, test explanations, respect witnesses without worshipping testimony, and recognise that mystery is not a conclusion. It is the beginning of better questions.
