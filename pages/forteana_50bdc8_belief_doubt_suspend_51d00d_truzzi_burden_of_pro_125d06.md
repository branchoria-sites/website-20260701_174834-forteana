...
show_ads: true
description: Truzzi's approach separates fair scepticism from confident dismissal by asking who has proved what.
hero_summary: Truzzi's approach separates fair scepticism from confident dismissal by asking who has proved what.
layout: default
...
title: What extraordinary proof really means
title_full: What extraordinary proof really means
display_title_short: Proof Burden
display_title: Proof Burden
heading_title: What extraordinary proof really means
page_heading_title: What extraordinary proof really means
source_count: 23
infographic_count: 3
planned_sections:
- Why claimants carry the first burden
- When sceptics also need evidence
- How to state doubt without overclaiming
...
header:
  og_image: /assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-1.webp
image: /assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-1-social.jpg
---
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/6T6cDtFIfVA" title="What to do when “Research Shows” shuts you down: A guide for parents and teachers (Ep 70)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=6T6cDtFIfVA" target="_blank" rel="noopener noreferrer">What to do when “Research Shows” shuts you down: A guide for parents and teachers (Ep 70)</a></p><p class="youtube-embed-meta">Channel: Chalk &amp; Talk with Anna Stokke</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=6T6cDtFIfVA" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=6T6cDtFIfVA">Open on YouTube</a></p></div></div></div>

## When sceptics also need evidence

Truzzi's distinctive contribution was insisting that the burden of proof is not permanently attached to believers alone.

He argued that a genuine sceptic occupies an agnostic position: the evidence has not yet established the claim. Simply declining to accept a proposition requires no proof beyond showing that the available evidence is insufficient.
...
<img src="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-2-dark.svg" | relative_url }}" alt="Proof Burden illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What extraordinary proof really means

One of the most common misunderstandings is that "extraordinary evidence" refers to a special kind of evidence. Truzzi's formulation is better understood as a proportional standard.

The strength of evidence should match the consequences of accepting the claim. A proposition requiring extensive revision of established understanding should be supported by correspondingly strong, independent and reproducible evidence.

In practice, stronger proof usually involves several features working together:


<div class="content-enhancement content-enhancement--comparison" markdown="1">

* Independent witnesses or observations.
* Reliable documentation collected close to the event.
* Alternative explanations being carefully investigated.
* Replication where replication is possible.
* Transparency about methods and uncertainties.
...
Truzzi's framework encourages careful language because certainty can exceed what the evidence justifies on either side.
...
* **"The evidence is insufficient."** This is a sceptical judgement about the present state of knowledge.
* **"The claim is false."** This is a stronger factual assertion requiring supporting evidence.
* **"A conventional explanation is possible."** This identifies a plausible hypothesis.
* **"A conventional explanation has been demonstrated."** This requires evidence that the proposed explanation actually fits the case.

</div>

For Fortean investigations, these distinctions matter because many historical reports remain incomplete. Missing photographs, degraded records, contradictory witness accounts or absent physical evidence may prevent either confirmation or refutation. Suspended judgement is therefore not indecision but recognition that confidence should reflect evidential quality rather than preference.


<img src="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-3-dark.svg" | relative_url }}" alt="Proof Burden illustration 3" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_belief_doubt_suspend_51d00d_truzzi_burden_of_pro_125d06-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why Truzzi's policy remains influential

Truzzi's formulation continues to shape debates over [UFO reports]({{ 'ufo-reports/' | relative_url }}), [cryptids]({{ 'cryptids/' | relative_url }}), paranormal experiences and other anomalous claims because it offers a governance principle for disagreement rather than a verdict about any specific phenomenon.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Historic perspective on extraordinary collective beliefs.</p>
        <div class="fr-book-actions">
