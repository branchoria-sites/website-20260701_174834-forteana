...
show_ads: true
description: A layered record can separate what was reported, what evidence exists, how the story spread, and what remains unresolved.
hero_summary: A layered record can separate what was reported, what evidence exists, how the story spread, and what remains unresolved.
layout: default
permalink: /layered-cases/
sidebar_expanded_urls:
- /forteana/
- /taxonomies/
nav_short_title: Layered Cases
title: How to File a Case Without Flattening It
title_full: How to File a Case Without Flattening It
display_title_short: Layered Cases
display_title: Layered Cases
heading_title: How to File a Case Without Flattening It
page_heading_title: How to File a Case Without Flattening It
source_count: 14
infographic_count: 3
planned_sections:
...
image: /assets/images/forteana_50bdc8_fortean_taxonomies_w_7e6998_layered_classificati_cbbfbc-Illustration-1-social.jpg
---
...
A layered record does not replace familiar Fortean categories. Instead, it adds structure without pretending that every anomaly belongs in only one drawer.

### Axis 1: What was actually reported?

The first layer records the primary claim exactly as it was made, before interpretation.
...
* Was it first-hand, second-hand or reconstructed later?
* What was directly observed?
* What happened in chronological order?
* Which elements entered only through later retellings?

</div>

Separating [observation]({{ 'observation/' | relative_url }}) from interpretation prevents an early assumption from shaping every later discussion. A witness who reports "a bright object descending silently" has not necessarily reported a spacecraft. Likewise, hearing unexplained footsteps is not automatically a haunting.

This descriptive layer remains deliberately neutral.

### Axis 2: What evidence survives?

The second layer classifies evidence rather than conclusions.
...
### Axis 3: How did the story spread?

The social history of a case deserves its own classification because many Fortean reports evolve substantially after the original event.
...
* Did newspapers reshape the narrative?
* Did local folklore absorb the event?
* Were new witnesses inspired after publicity?
* Did later books merge separate incidents?
* Have online discussions introduced details absent from the earliest reports?
...
The final layer records competing explanations without requiring an immediate verdict.

Possible explanatory classes might include:
...
* human activity;
* psychological or perceptual factors;
* folklore amplification;
* deliberate fabrication;
* genuinely unresolved anomaly.

</div>

Crucially, several explanations can remain active simultaneously.
...
A rural light may begin as an unidentified aerial observation but later become attached to local ghost stories. A supposed cryptid encounter may produce footprints that attract zoological investigation while simultaneously entering regional folklore. Reports of miraculous healing may combine medical records, religious interpretation, psychological [experience]({{ 'experience/' | relative_url }}) and media attention.

Flattening these into a single category loses important information.

Instead, a layered approach allows one case to belong simultaneously to several analytical streams:
...
## Why layered records reduce false certainty

Traditional filing systems encourage premature closure.

If a report is filed solely as a UFO case, later folklore elements may be ignored. If it is archived solely as folklore, physical evidence may disappear from consideration. If it becomes labelled a hoax, genuine observations that preceded the fabrication may never be revisited.

Layered classification instead distinguishes between different kinds of certainty.
...
* **The event occurred.**
* **Certain witnesses sincerely reported it.**
* **The physical evidence is disputed.**
* **Later retellings added unsupported details.**
* **No single explanation accounts for every component.**
...
A layered record might appear as follows.

### Primary report

Two independent witnesses describe a silent, hovering light lasting approximately three minutes before disappearing behind trees.

### Evidence profile

* Independent witness interviews conducted within 48 hours.
* One blurred photograph with uncertain distance.
* No confirmed radar data.
* Animal disturbance reported but undocumented.
* No verified physical traces recovered.

### Cultural and transmission history

The earliest newspaper article mentions only an unusual light.

Six months later, magazine features introduce claims of electromagnetic effects.
...
* astronomical or atmospheric [misidentification]({{ 'mistakes/' | relative_url }});
* unusual aircraft;
* memory distortion regarding later-added details;
* unresolved observation of unknown origin.

Rather than selecting one explanation prematurely, the record preserves the chronology of evidence while clearly separating original observations from accumulated interpretation.

## Preserving ambiguity without abandoning organisation

The strength of layered classification lies in recognising that a Fortean case is often several different things at once.
...
* a media phenomenon;
* an unresolved observational puzzle.

Recording these layers independently avoids two common mistakes. The first is forcing every anomaly into a rigid category that ignores complexity. The second is treating every extraordinary claim as an inseparable bundle in which every detail stands or falls together.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for comparing many forms of unexplained reports.</p>
        <div class="fr-book-actions">
