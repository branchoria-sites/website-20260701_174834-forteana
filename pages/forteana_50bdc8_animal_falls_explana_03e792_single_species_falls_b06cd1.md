...
show_ads: true
description: A fall made mostly of one species raises a harder question than scattered pond debris because real water bodies contain messy mixtures of life.
hero_summary: A fall made mostly of one species raises a harder question than scattered pond debris because real water bodies contain messy mixtures of life.
layout: default
permalink: /one-species/
sidebar_expanded_urls:
- /forteana/
- /animal-falls/
nav_short_title: One Species
title: Why Do Animal Falls Look So Selective?
title_full: Why Do Animal Falls Look So Selective?
display_title_short: One Species
display_title: One Species
heading_title: Why Do Animal Falls Look So Selective?
page_heading_title: Why Do Animal Falls Look So Selective?
source_count: 32
infographic_count: 3
planned_sections:
- The selection problem in fish and frog falls
- Schools, shorelines, and concentrated animals
- When selectivity points away from storm uplift
...
next_link:
  ...
  heading_title: Did Fish Really Rain on Texarkana?
header:
  og_image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-1.webp
image: /assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-1-social.jpg
---

## Introduction

One of the most persistent puzzles in reports of animal falls is not simply that fish, frogs or worms appear after a storm, but that they often appear to consist almost entirely of a single species. This matters because the leading natural explanation—storm uplift by [waterspouts]({{ 'waterspouts/' | relative_url }}) or powerful updraughts—would seem, at first glance, likely to collect a mixed sample of whatever happened to be present in the source water. The apparent selectivity therefore raises a legitimate question: why do so many reports describe only minnows, only frogs or only one kind of worm?
...
However, the apparent contradiction is not as decisive as it first appears. Several factors can produce genuine concentration without requiring a mysterious process:


<div class="content-enhancement content-enhancement--decision" markdown="1">

* Many fish naturally form schools composed almost entirely of one species.
* Young fish of the same age often occupy shallow water together.
* Amphibians gather seasonally in breeding ponds and may emerge in large numbers at similar life stages.
* Certain habitats are already dominated by a single species because predators, vegetation or water chemistry favour it.

</div>

The issue therefore becomes one of probabilities rather than impossibilities. A storm intersecting one dense aggregation could produce a much more selective sample than one passing over a biologically diverse pond.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/XTccXeJ3Los" title="What Wildlife lives in UK Ponds?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=XTccXeJ3Los" target="_blank" rel="noopener noreferrer">What Wildlife lives in UK Ponds?</a></p><p class="youtube-embed-meta">Channel: A Shot Of Wildlife</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=XTccXeJ3Los" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=XTccXeJ3Los">Open on YouTube</a></p></div></div></div>

## Schools, shorelines and concentrated animals

Animal populations are rarely distributed evenly across a body of water.
...
<img src="{{ "/assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-2-dark.svg" | relative_url }}" alt="One Species illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why reports can appear more selective than they really are

Witness descriptions often simplify what they observe.
...
* Journalists tend to emphasise the dominant species.
* Witnesses naturally focus on the most obvious animals.
* Small invertebrates or plant fragments may go unnoticed.
* Few historical cases preserved specimens for later analysis.

</div>

As a result, "only one species" often reflects the available observations rather than a complete biological inventory.
...
Even allowing for schooling behaviour and reporting bias, some descriptions remain awkward for the simplest waterspout explanation.

Investigators become more cautious when reports describe:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* perfect uniformity with no accompanying debris;
...
<img src="{{ "/assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-3-dark.svg" | relative_url }}" alt="One Species illustration 3" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_animal_falls_explana_03e792_single_species_falls_b06cd1-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Selectivity is a challenge, not a refutation
...
The strongest investigations therefore treat species composition as one piece of evidence among many. Weather records, geography, specimen identification, transport distance and witness reliability all contribute to judging whether an apparently selective animal fall reflects an unusual but natural event, a misunderstood local occurrence, or an account whose details cannot now be verified.
