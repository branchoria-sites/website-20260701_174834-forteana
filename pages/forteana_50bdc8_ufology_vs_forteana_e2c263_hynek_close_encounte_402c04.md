...
show_ads: true
description: Hynek's categories helped investigators separate distant lights from richer close encounter claims without proving an alien answer.
hero_summary: Hynek's categories helped investigators separate distant lights from richer close encounter claims without proving an alien answer.
layout: default
...
title: Why Close Encounters Needed Categories
title_full: Why Close Encounters Needed Categories
display_title_short: Hynek Scale
display_title: Hynek Scale
heading_title: Why Close Encounters Needed Categories
page_heading_title: Why Close Encounters Needed Categories
source_count: 26
infographic_count: 3
planned_sections:
- Nocturnal lights and daylight discs
- Radar visual cases and witness quality
- How Forteana reads the leftover strangeness
...
next_link:
  ...
  short_title: Magonia
  heading_title: Are UFO Stories Older Than Saucers?
date: '2026-07-01 17:41:11 '
header:
  og_image: /assets/images/forteana_50bdc8_ufology_vs_forteana_e2c263_hynek_close_encounte_402c04-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_ufology_vs_forteana_e2c263_hynek_close_encounte_402c04-Illustration-1.webp
image: /assets/images/forteana_50bdc8_ufology_vs_forteana_e2c263_hynek_close_encounte_402c04-Illustration-1-social.jpg
---
...
From a Fortean perspective, Hynek's classification is valuable precisely because it does **not** settle what [UFO reports]({{ 'ufo-reports/' | relative_url }}) ultimately represent. Instead, it organises experiences while leaving interpretation open.

A Fortean reader may note that close encounters often blur the boundary between observation and narrative. As reports become more elaborate, they may incorporate physical claims, unusual psychological experiences, [folklore]({{ 'folklore/' | relative_url }}) motifs or cultural expectations alongside descriptions of aerial objects. Rather than assuming these elements confirm extraterrestrial visitation, Forteana asks why certain patterns recur across different periods and cultural settings.

This produces a subtle contrast with traditional UFOlogy. UFO investigators often use the classification to decide which cases deserve deeper technical analysis. Forteana instead treats the same categories as a way of comparing how extraordinary experiences are described, remembered and transmitted. In that view, Hynek's system becomes less a ladder of proof than a map showing where ordinary observation gives way to increasingly complex human testimony.


<img src="{{ "/assets/images/forteana_50bdc8_ufology_vs_forteana_e2c263_hynek_close_encounte_402c04-Illustration-3-dark.svg" | relative_url }}" alt="Hynek Scale illustration 3" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_ufology_vs_forteana_e2c263_hynek_close_encounte_402c04-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_ufology_vs_forteana_e2c263_hynek_close_encounte_402c04-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What the classification achieved—and what it could not

Hynek's scale remains influential because it encouraged investigators to collect structured information instead of treating every report as an isolated curiosity. It recognised that observation conditions, proximity and independent corroboration all affect the evidential value of a case.

At the same time, the system has clear limits. Classification does not authenticate a report, eliminate misperception or resolve competing explanations. A carefully documented close encounter may still have an ordinary cause, while a distant observation can remain genuinely unidentified because the available information is too sparse. The lasting significance of Hynek's framework lies not in proving an alien hypothesis but in demonstrating that unusual reports become more comparable when investigators first decide exactly what kind of event they believe they are examining.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/eOfyhWyxqM8" title="Close Encounters of the Fifth Kind, CE-5 Protocols, ET Contact Method" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=eOfyhWyxqM8" target="_blank" rel="noopener noreferrer">Close Encounters of the Fifth Kind, CE-5 Protocols, ET Contact Method</a></p><p class="youtube-embed-meta">Channel: Ben Lovegrove &middot; Views: 14.5K &middot; Uploaded: October 2019</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=eOfyhWyxqM8" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=eOfyhWyxqM8">Open on YouTube</a></p></div></div></div>
