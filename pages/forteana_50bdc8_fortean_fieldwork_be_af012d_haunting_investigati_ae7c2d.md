...
show_ads: true
description: A haunting investigation can expose grief, fear, children, addresses, and health details, so consent and privacy are part of the evidence work.
hero_summary: A haunting investigation can expose grief, fear, children, addresses, and health details, so consent and privacy are part of the evidence work.
layout: default
permalink: /ethics/
...
header:
  og_image: /assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunting_investigati_ae7c2d-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunting_investigati_ae7c2d-Illustration-1.webp
image: /assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunting_investigati_ae7c2d-Illustration-1-social.jpg
---
...
* A homeowner inviting investigators inside is not automatically consenting to public release of photographs.
* Permission to record an interview is not necessarily permission to upload it to social media.
* One family member cannot normally grant consent on behalf of every resident or visitor.
* A witness may agree to anonymous quotation while refusing publication of their name, address or voice.

</div>

Changing circumstances also matter. Someone who initially welcomes publicity may later [experience]({{ 'experience/' | relative_url }}) unwanted attention from neighbours, journalists or online commentators. Reviewing publication plans before release is often better practice than relying on an old verbal agreement.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/EipeUP-mxsA" title="PARANORMAL INVESTIGATION: ETHICS - Guest, Randall Keller - FAMP" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=EipeUP-mxsA" target="_blank" rel="noopener noreferrer">PARANORMAL INVESTIGATION: ETHICS - Guest, Randall Keller - FAMP</a></p><p class="youtube-embed-meta">Channel: Tracey Lockwood</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=EipeUP-mxsA" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=EipeUP-mxsA">Open on YouTube</a></p></div></div></div>
...
* Interview adults before speaking with children whenever appropriate.
* Avoid asking children to repeat frightening stories in front of an audience or camera.
* Never pressure children to revisit locations that frighten them.
* Distinguish clearly between what a child directly observed and what they later heard from adults or siblings.
* Stop an interview if it becomes upsetting rather than pursuing dramatic details.

</div>


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/CVLKHRn79WU" title="What Are The Ethical Rules For Recording Paranormal Activity In Private Places?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=CVLKHRn79WU" target="_blank" rel="noopener noreferrer">What Are The Ethical Rules For Recording Paranormal Activity In Private Places?</a></p><p class="youtube-embed-meta">Channel: Inside the Supernatural</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=CVLKHRn79WU" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=CVLKHRn79WU">Open on YouTube</a></p></div></div></div>

## When evidence should stay private

Not every genuine piece of evidence belongs in the public domain. Exact addresses, interior photographs, security camera layouts, medical information, family disputes and identifiable recordings can expose witnesses to harassment or unwanted [tourism]({{ 'tourism/' | relative_url }}).

Sometimes withholding information actually strengthens an investigation. Retaining confidential details allows future witnesses to provide independent accounts without being influenced by material already circulating online. It also reduces the risk that fabricated reports simply repeat published descriptions.

Sensitive material may be better:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Archived privately with the owner's permission.
* Shared only with trusted collaborators who need it for verification.
* Published in anonymised form.
* Withheld indefinitely if publication would create disproportionate harm.

</div>

The value of evidence should never be judged solely by how widely it can be shared.


<img src="{{ "/assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunting_investigati_ae7c2d-Illustration-2-dark.svg" | relative_url }}" alt="Ethics illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunting_investigati_ae7c2d-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunting_investigati_ae7c2d-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Respect homes, property and communities

A reputedly haunted building is still someone's home, workplace or heritage site. Investigators should obtain permission before entering private property, avoid disrupting neighbours and leave locations exactly as they found them. Historic buildings deserve particular care because repeated unsupervised visits can damage fragile sites or encourage trespassing.

Ethics also extend to online behaviour. Publicly identifying private residences as "haunted" can attract curiosity seekers long after an investigation ends. Families who simply reported unexplained sounds or experiences may become unwilling tourist attractions through no fault of their own.

Responsible investigators therefore separate the public interest in unusual reports from the public's curiosity about specific households.

## Avoid creating the story you are trying to investigate

Ethical interviewing and reliable evidence reinforce each other. Leading questions, exaggerated reactions and repeated suggestions can unintentionally reshape memories. Witnesses may begin to describe what they think investigators expect instead of what they originally experienced.

A more ethical approach is to:

* Ask open questions before mentioning paranormal interpretations.
* Record uncertainty rather than filling gaps with speculation.
* Keep independent witnesses separate until each has given an account.
...
## Transparency, money and conflicts of interest
...
## A practical ethical standard for beginners

For newcomers to [Fortean fieldwork]({{ 'fieldwork/' | relative_url }}), a simple principle covers most situations: leave people better off than you found them. That means obtaining meaningful consent, protecting privacy, respecting homes, treating grief and fear with care, avoiding sensationalism, and preserving evidence without causing unnecessary harm. An investigation that gathers less material but maintains trust, dignity and confidentiality is ethically stronger—and often produces more reliable testimony—than one that prioritises publicity over the people whose experiences are being documented.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/NJo_1k_rT6k" title="Ghosts are a metaphor for letting go of reality | Deonna Kelli Sayed | TEDxGreensboro" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=NJo_1k_rT6k" target="_blank" rel="noopener noreferrer">Ghosts are a metaphor for letting go of reality | Deonna Kelli Sayed | TEDxGreensboro</a></p><p class="youtube-embed-meta">Channel: TEDx Talks</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=NJo_1k_rT6k" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=NJo_1k_rT6k">Open on YouTube</a></p></div></div></div>
