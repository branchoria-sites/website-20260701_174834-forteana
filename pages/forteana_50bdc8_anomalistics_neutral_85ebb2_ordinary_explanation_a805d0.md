...
show_ads: true
description: Misperception, coincidence, equipment error, fraud, and weather can explain many odd reports without accusing witnesses of bad faith.
hero_summary: Misperception, coincidence, equipment error, fraud, and weather can explain many odd reports without accusing witnesses of bad faith.
layout: default
...
title: When Weird Reports Have Ordinary Causes
title_full: When Weird Reports Have Ordinary Causes
display_title_short: Ordinary Causes
display_title: Ordinary Causes
heading_title: When Weird Reports Have Ordinary Causes
page_heading_title: When Weird Reports Have Ordinary Causes
source_count: 31
infographic_count: 3
planned_sections:
- Why sincere witnesses can still be wrong
- Environmental and equipment explanations
- Fraud, coincidence, and cultural expectation
...
next_link:
  ...
  heading_title: Why Sincere Witnesses Can Be Mistaken
header:
  og_image: /assets/images/forteana_50bdc8_anomalistics_neutral_85ebb2_ordinary_explanation_a805d0-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_anomalistics_neutral_85ebb2_ordinary_explanation_a805d0-Illustration-1.webp
image: /assets/images/forteana_50bdc8_anomalistics_neutral_85ebb2_ordinary_explanation_a805d0-Illustration-1-social.jpg
---
...
* Viewing unfamiliar objects at night, where distance and size are difficult to judge.
* Brief observations during surprise or stress.
* Strong emotional involvement.
* Discussions with other witnesses after the event, which can unintentionally harmonise memories.
* Exposure to media stories that provide ready-made interpretations.

</div>

None of these factors imply that witnesses are unreliable in general. They simply reflect normal properties of human perception.

## Environmental and equipment explanations

Many famous "mystery" sightings have later been traced to ordinary physical processes that initially looked extraordinary because observers lacked the necessary context.
...
Bright planets, meteors, satellite flares and rocket launches have repeatedly generated reports of unidentified aerial phenomena. Venus, in particular, has historically been mistaken for hovering aircraft or unusual craft because it can remain bright near the horizon for long periods and appears to shimmer dramatically through turbulent air.

Astronomical explanations become especially convincing when sightings match predictable celestial positions, allowing investigators to reconstruct what observers were likely seeing.


<img src="{{ "/assets/images/forteana_50bdc8_anomalistics_neutral_85ebb2_ordinary_explanation_a805d0-Illustration-2-dark.svg" | relative_url }}" alt="Ordinary Causes illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_anomalistics_neutral_85ebb2_ordinary_explanation_a805d0-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_anomalistics_neutral_85ebb2_ordinary_explanation_a805d0-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Instrument and sensor limitations

Modern sightings increasingly involve cameras, drones and electronic sensors rather than unaided [observation]({{ 'observation/' | relative_url }}). These technologies introduce their own sources of error.
...
* Compression artefacts in digital video.
* Autofocus errors.
* Infrared reflections invisible to the naked eye.
* Radar returns produced by atmospheric conditions or signal processing.

</div>

A sensor records physical signals rather than objective reality. Interpreting those signals requires understanding the instrument's limitations as well as its strengths.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/05NmTEeXvhs" title="Unexplained Earthquake Light Phenomenon Finally Captured on Camera" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=05NmTEeXvhs" target="_blank" rel="noopener noreferrer">Unexplained Earthquake Light Phenomenon Finally Captured on Camera</a></p><p class="youtube-embed-meta">Channel: Anton Petrov</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=05NmTEeXvhs" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=05NmTEeXvhs">Open on YouTube</a></p></div></div></div>
...
Cultural expectations further shape interpretation. During different historical periods, similar experiences have been described as fairy encounters, religious visions, ghost sightings, airships, flying saucers or secret military aircraft. The underlying observation may remain broadly similar while the preferred explanation reflects contemporary beliefs and available cultural stories.
...
## Why ordinary explanations are tested first
...
## The value of ordinary causes in neutral investigation

Ordinary explanations perform an important quality-control function within the study of Fortean reports. They prevent investigators from mistaking common errors for remarkable discoveries while also protecting genuinely unusual cases from being overshadowed by easily resolved ones.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Directly addresses ordinary explanations for extraordinary claims.</p>
