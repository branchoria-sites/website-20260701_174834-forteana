...
show_ads: true
description: Carbon monoxide, vibration, mould, draughts, sleep disruption, and expectation can turn a frightening house into a misleading witness environment.
hero_summary: Carbon monoxide, vibration, mould, draughts, sleep disruption, and expectation can turn a frightening house into a misleading witness environment.
layout: default
permalink: /house-hazards/
sidebar_expanded_urls:
- /forteana/
- /fieldwork/
nav_short_title: House Hazards
title: When the Haunted House Is the Clue
title_full: When the Haunted House Is the Clue
display_title_short: House Hazards
display_title: House Hazards
heading_title: When the Haunted House Is the Clue
page_heading_title: When the Haunted House Is the Clue
source_count: 24
infographic_count: 3
planned_sections:
- Safety checks before paranormal claims
- Environmental causes of presences and sounds
- When to pause an investigation
...
header:
  og_image: /assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunted_house_hazard_69c5f5-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunted_house_hazard_69c5f5-Illustration-1.webp
image: /assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunted_house_hazard_69c5f5-Illustration-1-social.jpg
---
...
* **Carbon monoxide risks** from faulty boilers, fires or flues.
* **Poor ventilation**, leading to elevated carbon dioxide and stale air.
* **Extensive damp and mould growth.**
* **Electrical faults** that present fire or shock hazards.
* **Structural instability**, especially in abandoned properties.
* **Animals**, including rodents or birds in roof spaces, which often generate unexplained noises.

</div>

For [Fortean fieldwork]({{ 'fieldwork/' | relative_url }}), documenting these conditions is valuable even if they do not fully explain every report. Eliminating hazards narrows the range of possible explanations and protects both investigators and witnesses.
...
### Mould, damp and poor indoor air
...
* Expanding or contracting timber that produces knocks.
* Water pipes that click or bang as temperatures change.
* Wind passing through gaps that creates whistles or voices.
* Loose fixtures that vibrate intermittently.
* Roof spaces occupied by birds, squirrels or rodents.

</div>

These mechanisms are often intermittent, making them appear mysterious until carefully traced.


<img src="{{ "/assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunted_house_hazard_69c5f5-Illustration-2-dark.svg" | relative_url }}" alt="House Hazards illustration 2" data-theme-src-dark="{{ "/assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunted_house_hazard_69c5f5-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/forteana_50bdc8_fortean_fieldwork_be_af012d_haunted_house_hazard_69c5f5-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Draughts and "cold spots"

Cold patches are among the oldest features of haunting reports, yet many buildings naturally develop localised temperature differences.
...
## Why witnesses can sincerely misinterpret a building

Environmental conditions do not operate in isolation. They interact with normal human [psychology]({{ 'psychology/' | relative_url }}).

A person exploring an unfamiliar building at night is already dealing with uncertainty. If they are tired, anxious or aware of the property's [haunted reputation]({{ 'place-reputation/' | relative_url }}), ambiguous sights and sounds become easier to interpret as meaningful.

Several factors commonly reinforce one another:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* **Sleep disruption**, especially repeated awakenings, increases dream-like experiences and confusion between sleep and wakefulness.
* **Expectation** encourages attention towards unusual noises while ignoring ordinary explanations.
* **Pareidolia** leads people to perceive faces or figures in shadows, peeling wallpaper or reflected light.
* **Confirmation bias** causes later experiences to be remembered as fitting an existing haunting narrative.
* **Social influence** means one person's description can shape how later witnesses interpret similar events.
...
The most responsible Fortean investigator knows when to stop gathering stories and start addressing safety.

Suspend any investigation immediately if there are signs of:


<div class="content-enhancement content-enhancement--caution" markdown="1">

* Carbon monoxide exposure, including headache, nausea, dizziness or confusion affecting multiple people.
* Active gas smells or combustion problems.
* Serious mould contamination.
* Structural instability.
* Electrical hazards or fire risk.
* Anyone becoming acutely ill while inside the property.
