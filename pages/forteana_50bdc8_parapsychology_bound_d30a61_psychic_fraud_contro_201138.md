...
show_ads: true
description: Many psychic tests fail or become disputed because ordinary cues, poor handling, or fraud can look like anomalous information.
hero_summary: Many psychic tests fail or become disputed because ordinary cues, poor handling, or fraud can look like anomalous information.
layout: default
permalink: /leakage-risks/
sidebar_expanded_urls:
- /forteana/
- /parapsychology/
nav_short_title: Leakage Risks
title: When Psychic Evidence Leaks Ordinary Clues
title_full: When Psychic Evidence Leaks Ordinary Clues
display_title_short: Leakage Risks
display_title: Leakage Risks
heading_title: When Psychic Evidence Leaks Ordinary Clues
page_heading_title: When Psychic Evidence Leaks Ordinary Clues
source_count: 20
infographic_count: 3
planned_sections:
- Sensory leakage in laboratory tests
- Fraud prevention in mediumship and experiments
- Why stronger controls change the claim
...
next_link:
  ...
  short_title: Psi Statistics
  heading_title: Why Significant Psi Results Are Not Enough
date: '2026-07-01 17:42:24 '
header:
  og_image: /assets/images/forteana_50bdc8_parapsychology_bound_d30a61_psychic_fraud_contro_201138-Illustration-1-social.jpg
  preview_image: /assets/images/forteana_50bdc8_parapsychology_bound_d30a61_psychic_fraud_contro_201138-Illustration-1.webp
image: /assets/images/forteana_50bdc8_parapsychology_bound_d30a61_psychic_fraud_contro_201138-Illustration-1-social.jpg
---
...
The history of psychic research shows why these controls matter. Many celebrated demonstrations have later been explained by sensory leakage, poor blinding, biased judging or outright fraud. At the same time, supporters of psi argue that increasingly strict protocols sometimes leave residual effects that deserve further investigation. The debate therefore centres less on extraordinary stories than on the quality of the experimental controls.

## When ordinary clues become "psychic" information

Sensory leakage refers to any situation in which information reaches a participant through normal means while appearing to have paranormal origins. The leakage may be obvious, such as overhearing a conversation, or so subtle that neither participant nor experimenter realises it has occurred.

In psychic research, leakage can arise through several mechanisms:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* **Visual cues:** reflections, visible markings, body language, facial expressions or accidental glimpses of targets.
* **Auditory cues:** overheard conversations, sounds from adjacent rooms or changes in an experimenter's voice.
* **Handling cues:** differences in the way target materials are shuffled, stored or presented.
* **Procedural cues:** experimenters unconsciously signalling correct answers through timing, posture or emphasis.
* **Information contamination:** participants learning details before testing through conversation, public records or social media.

</div>

These possibilities matter because humans are exceptionally good at detecting patterns and extracting information from weak signals. A participant may sincerely believe they are relying on intuition while unknowingly responding to ordinary cues.
...
Mediumship presents additional challenges because successful readings often depend on complex interactions between mediums, sitters and investigators.

Modern research attempts to prevent ordinary information transfer through layered controls such as:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Separating mediums and sitters into different rooms.
* Preventing anyone in contact with the medium from knowing the sitter's identity.
* Using anonymous identification codes instead of names.
* Randomising reading order.
* Employing double-blind or triple-blind procedures so neither participants nor evaluators know which reading belongs to which sitter.
* Using independent judges to assess matches after all readings have been completed.
...
## Why cold reading complicates psychic claims

Not all apparently accurate psychic performances involve conscious deception. One of the best-studied alternative explanations is **cold reading**: a collection of conversational techniques that create the impression of extraordinary knowledge.

Cold reading commonly involves:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Broad statements that fit many people.
* Gradually refining guesses based on reactions.
* Interpreting silence or emotion as feedback.
* Allowing clients to supply missing information.
* Remembering apparent "hits" while overlooking numerous misses.
...
## Historical lessons from exposed fraud
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/DRqlvqHBVCg" title="James Randi - Investigating Pseudoscientific and Paranormal Claims" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=DRqlvqHBVCg" target="_blank" rel="noopener noreferrer">James Randi - Investigating Pseudoscientific and Paranormal Claims</a></p><p class="youtube-embed-meta">Channel: Barry Belmont</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=DRqlvqHBVCg" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=DRqlvqHBVCg">Open on YouTube</a></p></div></div></div>

## Why stronger controls change the claim

The purpose of increasingly rigorous controls is not merely to make experiments harder. They fundamentally change what a positive result would mean.

An uncontrolled demonstration leaves many competing explanations available, including coincidence, cueing, selective memory, expectancy effects and fraud. Each additional safeguard removes one class of ordinary explanation:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* **Randomisation** reduces systematic bias.
* **Blinding** prevents expectations from influencing behaviour.
* **Double-blind procedures** stop both participants and experimenters from unintentionally transmitting information.
* **Automation** reduces human intervention.
* **Independent replication** tests whether an effect survives outside the original laboratory.
...
## Why leakage remains central to parapsychology
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains ordinary mechanisms behind paranormal beliefs.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for understanding both sides of the debate.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Shows how investigators confronted fraud historically.</p>
        <div class="fr-book-actions">
